...
function gutenburg_support() {
    add_theme_support( 'align-wide' );
  }
  add_action( 'after_setup_theme', 'gutenburg_support' );
...
function h5bs_primary_nav() {
    wp_nav_menu(array(
        ...
        'menu_class'      => 'nav-main nav group menu',    // custom class
...
function h5bs_footer_nav() {
    wp_nav_menu(array(
        ...
        'menu_class'      => 'nav-footer nav group menu vertical',       // custom class
